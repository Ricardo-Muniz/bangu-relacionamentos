    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        region.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String loc = (String) dataSnapshot.child("currentLocation").getValue();
            ...
            public void onClick(View v) {
               /* Toast.makeText(getContext(), "Filtro: " + TAG_CATEGORY_REGION + ", " +TAG_CATEGORY_SEX + ", "
                ...
                if (!TAG_CATEGORY_REGION.isEmpty() || !TAG_CATEGORY_SEX.isEmpty()) {
                    ...
                    intent.putExtra("person", "comu");

                    editor.putString("countryRegion", TAG_CATEGORY_REGION);
                    editor.putBoolean("filterActive", true);
                    editor.putString("sexPerson", TAG_CATEGORY_SEX);
                    editor.putLong("ageMin", TAG_CATEGORY_AGE_MIN);
                    editor.putLong("ageMax", TAG_CATEGORY_AGE_MAX);
